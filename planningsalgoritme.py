...
# Houd bij op welke rij het EERSTE lange halfuur van minderjarige vroege stoppers kwam
...
pp2_minderjarige_eerste_halfuur_rij = dict(pp2_minor_early_stopper_first_long_row)
